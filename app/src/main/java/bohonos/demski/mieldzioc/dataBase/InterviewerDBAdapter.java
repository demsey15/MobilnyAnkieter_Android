...
public class InterviewerDBAdapter {
    ...
    /**
     * Zwraca ankietera albo null, jeśli nie ma w bazie takiego ankietera.
     * @param id
     * @return
     */
    ...
    /**
     * Sprawdza hasło dla danego ankietera, false, jeśli nie ma ankietera w bazie.
     * @param id
     * @param password
     * @return
     */
    ...
    /**
     * Pobierz id szablonów ankiet, które może wypełniać dany ankieter. Nie trzeba otwierać i zamykać
     * połączenia.
     * @param interviewer
     * @return
     */
